...
// ==========================================
let inactivityTimer;
const TEMPO_LIMITE_MINUTOS = 30; // Tempo máximo inativo
...
// Ouve as ações do usuário na tela inteira para zerar o cronômetro
...
onAuthStateChanged(auth, (user) => { 
  ...
  renderServidores(); 
  renderPortarias(); 
  resetInactivityTimer(); // Inicia o contador ao logar
});
